...
const loginUser = async (req,res,next)=>{
    ...
    res.status(200).json({userType: user[0].userType,token: tokenResult.token,userId: user[0].id})
}
...
const signupUser = async (req,res,next)=>{
    ...
    res.status(200).json({userType,token: tokenResult.token,userId: user[0].id})
